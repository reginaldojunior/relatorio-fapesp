...
function Y {
  ...
  export RESULT_DIR=/home/reginaldojunior/Documentos/UFscar/experimentos/boosting/results/$3
  faux=${1##*\/}
  onlyname=${faux%%.*}
  echo "$1 $2 $3"
  if [[ $2 == *"MAX"* ]]; then
...
function X {
  declare -a algs=(
  "meta.OzaBoost" "meta.OzaBoostRUNPER"
  )
  if [[ $2 == *"Oza"* ]]; then
    ID=0
  fi
...
mkdir -p /home/reginaldojunior/Documentos/UFscar
mkdir -p /home/reginaldojunior/Documentos/UFscar/experimentos
mkdir -p /home/reginaldojunior/Documentos/UFscar/experimentos/boosting/results
mkdir -p /home/reginaldojunior/Documentos/UFscar/experimentos/boosting/results/first \
         /home/reginaldojunior/Documentos/UFscar/experimentos/boosting/results/second \
         /home/reginaldojunior/Documentos/UFscar/experimentos/boosting/results/third
